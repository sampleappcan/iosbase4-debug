...
- (id) init
{
	if (self = [super init]) {
        ...
        self.useStartReportURL = @"http://newdc.appcan.cn/";
        self.useAnalysisDataURL = @"http://newdc.appcan.cn/";
        self.useBindUserPushURL = @"http://newpush.appcan.cn/";
        ...
        self.useAppCanUpdateURL = @"http://storeb.appcan.cn/";
