    ...
    SliderView.prototype = {
        ...
        _moveTo:function(index,anim){
            ...
            if(self.option.hasLabel){
                if(self.option.data[self.option.index+1]!= null && self.option.data[self.option.index+1]!= undefined && self.option.data[self.option.index+1]!="undefined"){
                    self.label.html(self.option.data[self.option.index+1].label);
                }               
            }
            if(self.option.hasCircle){
               // console.log(self.option.index+1);
               if(self.option.data[self.option.index+1]!= null && self.option.data[self.option.index+1] != undefined && self.option.data[self.option.index+1]!="undefined"){
